...
d = fgetc(input);
if(((d >= 48) && (d <= 57))||((d >= 65) && (d <= 90))||((d >= 97) && (d <= 124))){
*p = d;
while((( d >= 48) && (d <= 57))||((d >= 65) && (d <= 90))||((d >= 97) && (d <= 124))){
d = fgetc(input);
count++;
...
char b;
b = *(p + count - 1);
if(((b >= 33) && (b <= 47))||((b >= 58) && (b <= 64))||((b >= 91) && (b <= 95))||(b == 125)){
*(buf) = '~';
*(buf + 1) = b;
*(p + count - 1) = '\0';
...
else if(((d >= 33) && (d <= 47))||((d >= 58) && (d <= 64))||((d >= 91) && (d <= 95))||(d == 125)) 
{
count++;
p = (char *)realloc(p,count*sizeof(char));
*(p) = '~';
